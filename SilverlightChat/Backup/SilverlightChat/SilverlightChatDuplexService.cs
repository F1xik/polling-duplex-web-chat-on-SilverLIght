...
namespace SilverlightChatDuplexService
{
    ...
    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class SilverlightChatDuplexService : ISilverlightChatDuplexService
    {
        /// <summary>
        /// The list of connected clients. When a timeout occurs, they are removed from the client list.
        /// </summary>
        private static List<IDuplexClient> clients = new List<IDuplexClient>();
        private IDuplexClient localClient;
        ...
        public SilverlightChatDuplexService()
        {
        ...
        private void StayAlivePing(object notUsed)
        {
            lock (lockObject)
            {
        ...
        private void SendData(ChatData data)
        {
